...
jQuery.extend( {
	...
	isEmptyObject function( obj ) {
		 ...
		 eslint-disable no-unused-vars 
		 See httpsgithub.comeslinteslintissues6125
		var name;
...
var i,
	...
	rcssescape = ([0-x1fx7f]^-d)^-$[^x80-uFFFFw-]g,
...
function createDisabledPseudo( disabled ) {
	 ...
	 not IE fieldset[disabled]  legendnth-of-type(n+2) can-disable
	return function( elem ) {
...
var
	 ...
	 See httpsgithub.comeslinteslintissues3229
	rxhtmlTag = (!areabrcolembedhrimginputlinkmetaparam)(([a-z][^0x20trnf])[^])gi,
